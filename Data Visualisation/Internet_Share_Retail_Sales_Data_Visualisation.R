...
ons_retail_title <- "In the UK lockdowns, the internet share of retail sales ratcheted up above one in four pounds."
ons_retail_subtitle <- paste0("Average weekly retail sales value (in £ million) by internet and non-internet purchase, and the internet share of total retail sales (rounded to one decimal place). Figures are not seasonally adjusted, ",
